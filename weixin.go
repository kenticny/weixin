...
type ResponseWriter interface {
	...
	PostTemplateMessage(templateid string, url string, data TmplData) (int64, error)
	// Media operator
...
func (w responseWriter) PostTemplateMessage(templateid string, url string, data TmplData) (int64, error) {
